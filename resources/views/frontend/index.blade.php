        ...
        <div class="container">
            ...
            <div class="row gx-0 services__active">
                    ...
                    <div class="services__item">
                        ...
                        <div class="services__content">
                            <div class="services__icon">
                                ...
                                <img class="dark" src="a{{asset('frontend/ssets/img/icons/services_icon01.png')}}" alt="">
                            </div>
                ...
                <div class="col-xl-3">
                    <div class="services__item">
                        <div class="services__thumb">
                            <a href="services-details.html"><img src="{{asset('frontend/')}}{{asset('frontend/')}}assets/img/images/services_img02.jpg" alt=""></a>
                        </div>
                        <div class="services__content">
                            <div class="services__icon">
